...
def test_call_returns_discharge_slots_when_surplus_energy_and_peak_prices(
    ...
    battery_discharge_slot = battery_discharge_slot_estimator(state, period_start, period_hours=6)
