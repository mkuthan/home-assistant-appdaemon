...
class TestForecastConsumptionComposite:
    def test_estimate_energy_kwh(self) -> None:
        ...
        forecast_consumption = ConsumptionForecastComposite(component_1, component_2)
...
class TestForecastConsumptionRegular:
    def test_estimate_energy_kwh_away_mode(self) -> None:
        ...
        result = forecast_consumption.estimate_energy_kwh(period_start=period_start, period_hours=4)

        # 0.5 * 4 hours = 2.0 kWh
        assert result.value == pytest.approx(2.0)

    def test_estimate_energy_kwh_home_mode_daytime_only(self) -> None:
        forecast_consumption = ConsumptionForecastRegular(
            is_away_mode=False,
            evening_start_hour=16,
            consumption_away=EnergyKwh(0.5),
    ...
    def test_estimate_energy_kwh_home_mode_evening_only(self) -> None:
        forecast_consumption = ConsumptionForecastRegular(
            is_away_mode=False,
            evening_start_hour=16,
            consumption_away=EnergyKwh(0.5),
    ...
    def test_estimate_energy_kwh_home_mode_crossing_evening_boundary(self) -> None:
        forecast_consumption = ConsumptionForecastRegular(
            is_away_mode=False,
            evening_start_hour=16,
            consumption_away=EnergyKwh(0.5),
...
class TestForecastConsumptionHvacHeating:
    ...
    def test_estimate_energy_kwh_eco_mode(self, mock_forecast_weather: Mock) -> None:
    ...
    def test_estimate_energy_kwh_heating_mode_off(self, mock_forecast_weather: Mock) -> None:
        forecast_consumption = ConsumptionForecastHvacHeating(
            is_eco_mode=False,
    ...
    def test_estimate_energy_kwh_heating_mode_heat_no_weather_data(self, mock_forecast_weather: Mock) -> None:
        ...
        result = forecast_consumption.estimate_energy_kwh(period_start=period_start, period_hours=2)
